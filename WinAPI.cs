...
namespace SharePodLib.WinApi
{
    ...
    [Flags]
    internal enum DeviceIOFileDevice : uint
    {
        Beep = 0x00000001,
        CDRom = 0x00000002,
    ...
    [Flags]
    internal enum DeviceIOMethod : uint
    {
        Buffered = 0,
        InDirect = 1,
        OutDirect = 2,
    ...
    [Flags]
    internal enum FileAttributesAndFlags : uint
    {
    ...
    internal enum DeviceChangeEvent
    {
    ...
    internal struct ScsiPassThroughWithBuffers
    {
