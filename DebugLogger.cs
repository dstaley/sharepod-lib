    ...
    public static class DebugLogger
    {
        ...
        public static void StartLogging(string filename)
        {
            ...
            try
            {
                ...
                string libFileName = Assembly.GetExecutingAssembly().GetModules()[0].FullyQualifiedName;
                Trace.WriteLine("===============================");
                Trace.WriteLine("SharePodLib Version: " + FileVersionInfo.GetVersionInfo(libFileName).FileVersion);
                Trace.WriteLine("===============================");
