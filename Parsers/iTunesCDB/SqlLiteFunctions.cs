    ...
    static class Icu
    {
        ...
        public static void Initialize()
        {
            if (Collator == null)
            {
                ...
                SharePodLib.UnpackEmbeddedResource("icudt40.dll");
                SharePodLib.UnpackEmbeddedResource("icuin40.dll");
                SharePodLib.UnpackEmbeddedResource("icuuc40.dll");
