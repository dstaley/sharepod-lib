...
namespace SharePodLib.Parsers.Artwork
{
    ...
    public class SupportedArtworkFormat
    {
        ...
        private uint _width, _height, _iThmbBlockSize;
        private PixelFormat _pixelFormat;
        internal bool VideoOnly { get; set; }

        internal SupportedArtworkFormat(uint formatId, PixelFormat pixelFormat, uint iThmbBlockLength)
        ...
        internal SupportedArtworkFormat(uint formatId, PixelFormat pixelFormat, uint width, uint height)
        {
            _formatId = formatId;
            _pixelFormat = pixelFormat;
            _width = width;
        ...
        {
            return String.Format("{0}x{1} {2}", _width, _height, _pixelFormat.ToString());
        }

        internal static SupportedArtworkFormat GetByFormatId(uint formatId, List<SupportedArtworkFormat> formats)
        {
            SupportedArtworkFormat format = formats.Find(delegate(SupportedArtworkFormat testformat) { return testformat.FormatId == formatId; });
            return format;
        }
