...
namespace SharePodLib.Parsers.iTunesDB
{
    ...
    public class Track : BaseDatabaseElement
    {
        ...
        private UInt64 _dbId2;
        bool _hasLyrics, _isVideoFile;
        private byte[] _unk4, _unk5;
        private int _mediaType;
        private uint _artworkIdLink;
        private Int16 _hasGaplessData;
        ...
        internal override void Read(IPod iPod, BinaryReader reader)
        {
            ...
            if (_headerSize > 352)
            {
                long previousPostion = reader.BaseStream.Position;
        ...
        {
            long startOfElement = writer.BaseStream.Position;
        ...
        public string Title
        {
            get { return GetDataElement(MHODElementType.Title); }
            set
            {
        ...
        public string Artist
        {
            get
            {
                string artist = GetDataElement(MHODElementType.Artist);
        ...
        public string Album
        {
            get
            {
                string album = GetDataElement(MHODElementType.Album);
        ...
        {
            get { return GetDataElement(MHODElementType.Comment); }
            set { SetDataElement(MHODElementType.Comment, value); }
        }

        public string Composer
        {
            get { return GetDataElement(MHODElementType.Composer); }
        ...
        public string AlbumArtist
        {
            get
            {
                string artist = GetDataElement(MHODElementType.AlbumArtist);
        ...
        {
            get { return GetDataElement(MHODElementType.DescriptionText); }
        ...
        public string FilePath
        {
            get 
            { 
                string path = GetDataElement(MHODElementType.FilePath);
                if (path.StartsWith(":"))
            ...
            internal set 
            {
                string path = Helpers.StandardPathToiPodPath(value);
                if (!path.StartsWith(":"))
                    path = ":" + path;
                SetDataElement(MHODElementType.FilePath, path);
                UnicodeMHOD mhod = (UnicodeMHOD)GetChildByType(MHODElementType.FilePath);
        ...
        {
            get { return GetDataElement(MHODElementType.FileType); }
        ...
        {
            get { 
                string genre = GetDataElement(MHODElementType.Genre);
        ...
        {
            get { return _sampleRate / 0x10000; }
        }
        ...
        public int VolumeAdjustment
        {
            ...
            set
            {
                if (value < -255 || value > 255)
                    throw new InvalidValueException("The Volume Adjustment field should be between -255 and 255");
        ...
        {
            get { return (MediaType)_mediaType; }
            set
            {
        ...
        {
            get { return _rememberPlaybackPosition; }
            set
            {
        ...
        {
            get { return _podcastFlag; }
            set { _podcastFlag = value; }
        }

        public uint ArtworkIdLink
        {
            get { return _artworkIdLink; }
        ...
        /// </summary>
        public List<IPodImageFormat> Artwork
        {
            get { return _artwork; }
        }
        ...
        {
            StringMHOD mhod = GetChildByType(type);
            if (mhod != null)
                return mhod.Data;
            else
                return String.Empty;
        ...
        internal void Create(IPod iPod, NewTrack newTrack)
        {
            ...
            FileInfo fileInfo = new FileInfo(newTrack.FilePath);
            if (!fileInfo.Exists)
            {
            ...
            if (!String.IsNullOrEmpty(newTrack.DescriptionText))
                this.DescriptionText = newTrack.Composer;
            ...
            else if (newTrack.FilePath.EndsWith(".m4b", StringComparison.InvariantCultureIgnoreCase))
        ...
        internal List<BaseMHODElement> Children
        {
        ...
        {
            return string.Format("Title: {0}\r\nArtist: {1}\r\nAlbum: {2}\r\nGenre: {3}\r\nRating: {4}", this.Title, this.Artist, this.Album, this.Genre, this.Rating);
        }
        ...
        public string SortTitle
        {
            get
            {
                string title = GetDataElement(MHODElementType.TitleSortBy);
        ...
        public string SortAlbum
        {
            get
            {
                string album = GetDataElement(MHODElementType.AlbumSortBy);
                if (album != String.Empty) return album;
                return Album;
            }
        }
        public string SortArtist
        {
            get
            {
                string artist = GetDataElement(MHODElementType.ArtistSortBy);
                if (artist != String.Empty) return artist;
                return Artist;
            }
        }
